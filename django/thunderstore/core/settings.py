...
env = environ.Env(
    ...
    LOGOUT_ALLOWED_REDIRECT_HOSTS=(list, []),
    ...
    REPOSITORY_MAX_FILE_COUNT_PER_ZIP=(int, 10000),
...
COMMUNITY_IMAGE_HOST = env.str("COMMUNITY_IMAGE_HOST", default="")
...
REPOSITORY_MAX_FILE_COUNT_PER_ZIP = env.int("REPOSITORY_MAX_FILE_COUNT_PER_ZIP")
...
LOGOUT_ALLOWED_REDIRECT_HOSTS = env.list("LOGOUT_ALLOWED_REDIRECT_HOSTS")
SOCIAL_AUTH_INIT_HOST = env.str("SOCIAL_AUTH_INIT_HOST") or None
AUTH_EXCLUSIVE_HOST = env.str("AUTH_EXCLUSIVE_HOST") or None
OLD_EXCLUSIVE_HOST = env.str("OLD_EXCLUSIVE_HOST") or None
